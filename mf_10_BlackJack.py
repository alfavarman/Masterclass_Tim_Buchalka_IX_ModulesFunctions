...
# Dealer Button
buttonDealer = tkinter.Button(frameButtons, text='Dealer', relief='raised', borderwidth=2)
buttonDealer.grid(row=0, column=0)
# Player Button
buttonPlayer = tkinter.Button(frameButtons, text='Player', relief='raised', borderwidth=2)
