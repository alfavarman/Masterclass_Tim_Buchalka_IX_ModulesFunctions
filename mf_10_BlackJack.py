...
def deal_card(frame):
    ...
    # add card in the back of a deck
...
# shuffle
buttonShuffle = tkinter.Button(frameButtons, text='Shuffle', relief='raised', borderwidth=10, command=shuffle)
buttonShuffle.grid(row=0, column=3)
